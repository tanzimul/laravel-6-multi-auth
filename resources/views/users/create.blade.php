    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form method="POST" action="{{ route('users.store') }}" class="mt-5">
                ...
                <input id="password" type="hidden" name="password" value="pass123">
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="user_role" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
